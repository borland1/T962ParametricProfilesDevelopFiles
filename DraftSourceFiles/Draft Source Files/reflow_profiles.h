...
// void Reflow_LoadCustomProfiles(void);  // function not used with Parameter Profiles // ******************
...
int Reflow_SaveEEProfile(void); // not used with parameter profiles
...
// void Reflow_SetSetpointAtIdx(uint8_t idx, uint16_t value); // not used with parameter profiles // ***********
