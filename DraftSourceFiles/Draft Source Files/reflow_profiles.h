#ifndef REFLOW_PROFILES_H // ****************
#define REFLOW_PROFILES_H // ****************

#include <string.h> // for string functions ********************
#include <stdint.h>  // For uint8_t if needed // **********************
#include <stddef.h>  // For size_t if needed  // **********************
#include <stdbool.h>   // For bool if used  // **********************
#include "nvstorage.h" // For NV_GetConfig() // ***********************
...
// extern const int NUM_PARAMETER_PROFILES; // *********************
...
// Packing sizes for each parameter // *********
const PackSize paramPackingType	[PROFILE_PARAM_COUNT] = { // ***********
