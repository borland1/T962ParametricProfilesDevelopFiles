...
static int32_t Main_Work(void) {
	...
	if (mode == MAIN_SETUP) {
		...
		char phaseStr[10]; // *********************
		if (ticks < endTime.preheat) strcpy(phaseStr, "Preheat"); // *********************
		else if (ticks < endTime.soak) strcpy(phaseStr, "Soak"); // *********************
		else if (ticks < endTime.reflow) strcpy(phaseStr, "Reflow"); // *********************
		else strcpy(phaseStr, "Cooldown"); // *********************
		...
		char displayLine[20]; // *********************
		strncpy(displayLine, scrollText + scrollOffset, 19); // *********************
		displayLine[19] = '\0'; // *********************
