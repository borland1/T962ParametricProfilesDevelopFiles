...
static int32_t Main_Work(void) {
	...
	if (mode == MAIN_SETUP) {
		...
		// buttons
		y = 64 - 7;
		// LCD_disp_str((uint8_t*)" < ", 3, 0, y, FONT6X6 | INVERT);  // not used // ****************
		// LCD_disp_str((uint8_t*)" > ", 3, 20, y, FONT6X6 | INVERT); // not used // ****************
		// LCD_disp_str((uint8_t*)" - ", 3, 45, y, FONT6X6 | INVERT); // not used // ****************
		// LCD_disp_str((uint8_t*)" + ", 3, 65, y, FONT6X6 | INVERT); // not used // ****************
		// LCD_disp_str((uint8_t*)" DONE ", 6, 91, y, FONT6X6 | INVERT); // not used // ****************
		LCD_BMPDisplay(editParamMenubmp, 0, y); // this used instead // ****************
		...
		y = 64 - 7;  // ****************************************************
		/**/  // ************************
		LCD_BMPDisplay(editNameMenubmp, 0, y); // ****************
		/**/  // ************************
		/* // *****************************
