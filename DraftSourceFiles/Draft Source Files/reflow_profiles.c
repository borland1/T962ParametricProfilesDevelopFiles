...
// Reflow	 // *************************
    {"SOLDER MELT     %3.0f`", REFLOW_SOLDER_MELT_TEMP, 0, 350, 1.0f}, // *************************
	{"TEMP DELTA ABOVE\nSOLDER MELT TEMP %2.0f`", REFLOW_OVERSHOOT_MELT_TEMP_DELTA, 0, 60, 1.0f}, // *************************
	{"HEAT RATE     %1.1f`/S", REFLOW_HEAT_RATE, 0, 25, 0.1f}, // *************************
	{"DWELL TIME ABOVE\nMELT TEMP       %3.0fS", REFLOW_DWELL_TIME_ABOVE_MELT_TEMP, 0, 250, 1.0f}, // *************************
// Cooldown // *************************
	{"COOLDOWN RATE %1.1f`/S", COOLDOWN_RATE, 0, 50, 0.1f},  // *************************
...
void Reflow_computeTempDatasetFromParams( paramProfile *e4, ramprofile *e3 ) {  // ******************
	...
	// Preheat  // ******************
	endTime.preheat = (float) e4->params[SOAK_START_TEMP] - ( (e4->params[PREHEAT_HEAT_RATE] == 0 ) ? 0 : ( (float) e4->params[PREHEAT_START_TEMP] /  // ******************
