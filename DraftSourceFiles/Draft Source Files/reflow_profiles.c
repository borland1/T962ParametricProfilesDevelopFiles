...
// Preheat // **************** // except for rates, multipliers alway 1.0f // *************************
	...
	{"DWELL TIME   %3.0f SEC", PREHEAT_START_TEMP_DWELL_TIME, 0, 480, 1.0f}, // *************************
	{"HEAT RATE  %1.1f `/SEC", PREHEAT_HEAT_RATE, 0, 25, 0.1f}, // *************************
// Soak // *************************
    {"START TEMP     %3.0f `", SOAK_START_TEMP, 0, 350, 1.0f}, // *************************
	{"TARGET TEMP    %3.0f `", SOAK_END_TARGET_TEMP, 0, 350, 1.0f}, // *************************
	{"DWELL TIME   %3.0f SEC", SOAK_DWELL_TIME, 0, 250, 1.0f}, // *************************
    {"HEAT RATE  %1.1f `/SEC", SOAK_HEAT_RATE, 0, 25, 0.1f}, // *************************
// Reflow	 // *************************
	...
	{"HEAT RATE    %1.1f `/SEC", REFLOW_HEAT_RATE, 0, 25, 0.1f}, // *************************
	{"DWELL TIME ABOVE\n   MELT TEMP  %3.0f SEC", REFLOW_DWELL_TIME_ABOVE_MELT_TEMP, 0, 250, 1.0f}, // *************************
// Cooldown // *************************
	{"COOLDOWN RATE  %1.1f `/SEC", COOLDOWN_RATE, 0, 25, 0.1f},  // *************************
