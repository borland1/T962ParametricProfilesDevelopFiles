...
void IO_JumpBootloader(void) {
	...
	if ((IOPIN0 & (1 << 17)) == 0) { // P0.23 remapped to P0.17 // *************************
...
void IO_Init(void) {
	...
	// Unused pins P0.5, P0.6, P0.10, P0.17, P0.24, P0.26, P0.27, P0.30   // ********************
	// Remap pin swaps(using P0.5, P0.6, P0.17, instead of using P0.15,P0.16,P0.23) // **************
	// FIO0MASK = 0b01001101000000100000010001100000; // Mask out all unknown/unused pins // **************
	FIO0MASK = 0b01001101000000000000010000000000; // Mask out all unknown/unused pins // **************
