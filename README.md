...
**Arduino Sketch Files** – https://github.com/borland1/T962ParametricProfilesDevelopFiles/tree/main/Arduino - Three Arduino sketches were developed to code the structures of profile parameters, calculating the time/temperature dataset from parameters, including 16-bit to 9-bit and 6-bit packing, unpacking, and read/write parameters for each profile to non-volatile storage in **EEPROM**.
...
**EEPROM Space Allocation.txt** - https://github.com/borland1/T962ParametricProfilesDevelopFiles/blob/main/EEPROM%20space%20allocation.txt Provides an EEPROM address space availability and layout of Setup/Calibration Settings and Parameter Profiles.  

**LCDparameterProfileMenusLayout.txt** - https://github.com/borland1/T962ParametricProfilesDevelopFiles/blob/main/LCDparameterProfileMenusLayout.txt A LCD menu structure and layout for user profile parameter editing and restoring firmware default values.
